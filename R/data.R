...
#'
#' A dataset containing Allele counts, haplotype phasing and copy number information on chromosome 10 
...
#'   \item{minor_copynumber_df}{A data frame containing the normal cell contamination rate for each mutations  at each tumour samples}
#' }
"chr10_OP1019"
