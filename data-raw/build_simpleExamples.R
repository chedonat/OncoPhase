...
colnames(phasing_association_df) = c("Phased_List")
rownames(phasing_association_df) = c("mutation1")
phasing_association_df["mutation1","Phased_List"] = "mutation2"
...
devtools::use_data(simpleExample1, overwrite=TRUE)
attach(simpleExample1)
#prevalence_I=getPrevalence(snp_allelecount_df, ref_allelecount_df, phasing_association_df, major_copynumber_df,minor_copynumber_df,normalfraction_df,nbFirstColumns=nbFirstColumns,tumoursamples=tumoursamples, region=region)
...
colnames(phasing_association_df) = c("Phased_List")
phasing_association_df["mutation2","Phased_List"] = "mutation1:mutation3"
phasing_association_df["mutation6","Phased_List"] = "mutation4:mutation5:mutation7"
...
devtools::use_data(simpleExample2, overwrite=TRUE)
attach(simpleExample2)
#prevalence_II=getPrevalence(snp_allelecount_df, ref_allelecount_df, phasing_association_df, major_copynumber_df,minor_copynumber_df,normalfraction_df)
